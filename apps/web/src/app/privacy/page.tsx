...
export const metadata: Metadata = {
	title: "Privacy Policy - OpenScript",
	description:
		"Learn how OpenScript handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	openGraph: {
		title: "Privacy Policy - OpenScript",
		description:
			"Learn how OpenScript handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>
								OpenScript does not currently require an account or login
							</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					OpenScript does not currently offer user accounts, login, or Google
					sign-in.
				</p>
				<p>
			...
			<section className="flex flex-col gap-3">
				...
				<p>OpenScript integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					<li>No account is required to use OpenScript today</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					OpenScript is completely open source. You can review our code, see
